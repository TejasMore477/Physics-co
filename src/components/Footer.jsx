    ...
    <div data-scroll data-scroll-section data-scroll-speed="0.3" className='w-full h-screen bg-gray-900 flex flex-col items-start justify-between px-16 py-9 z-50'>
      ...
      <div className='w-full flex flex-col justify-between border-t-2 border-gray-800'>
        <div className='w-full h-[70vh] '>
            ...
            <p className='w-1/2 text-gray-500 text-md mt-[2vh]'>We are providong something unique, useful and most impoertant fun.By giving students a too to find instant solutions to their studies, We are trying to make every student self-sufficient in practicing and completing their homework</p>
        </div>
